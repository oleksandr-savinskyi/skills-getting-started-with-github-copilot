  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
          ...
          <div class="participants">
            ...
            ${details.participants && details.participants.length ? `
              <ul class="participants-list">
                ${details.participants.map(p => `<li class="participant-item">${p}<button class="participant-remove" data-activity="${name}" data-email="${p}">✕</button></li>`).join("")}
              </ul>
        ...
        // Handle remove participant clicks inside this card
